from enums import AvailabilityStatus, RideStatus
from user import User

class Driver(User):
    def __init__(self, name, email, phone, user_id, current_location, driver_id, availability_status=AvailabilityStatus.OFFLINE):
